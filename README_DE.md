...
**RTS-KI für [Project Nova / Hashkrieg](https://github.com/VibecodingGermany/Project_Nova)** — adaptive Ziele und NPC-Verhalten für Wirtschaft, Armee, Expansion, Verteidigung, Angriff, Belagerung und Bewegung. Dafür entwickle ich [Nova.AiLab](https://github.com/arn-c0de/Nova.AiLab) als Simulationsumgebung zum Vergleich verschiedener KI-Versionen aus unterschiedlichen Branches. Laborergebnisse sind Diagnosen; im Live-Spiel ungesehene Effekte bleiben als ungesehen markiert.
...
- ![Private](https://img.shields.io/badge/access-private-lightgrey?style=flat-square) **JobFinder** - Self-hosted Workspace zum Sammeln, Deduplizieren und Verwalten von Jobs, Freelance-Projekten und öffentlichen Ausschreibungen. **Aktuell privat** — Testversionen und Mitarbeit auf Anfrage, siehe [Sicherer Kontakt](SECURE-CONTACT.md).
