...
- **Programmation :** Rust, C/C++ (Windows), bas niveau, Java/Kotlin, design patterns
- **Sécurité :** reverse engineering et patching APK, hardening, recherche, revue de code sécurisé
...
- [![Issues](https://img.shields.io/github/issues/arn-c0de/ESP32-LABs?style=flat-square&color=blue)](https://github.com/arn-c0de/ESP32-LABs/issues) [**ESP32-LABs**](https://github.com/arn-c0de/ESP32-LABs) - Collection de labs éducatifs et expérimentaux basés sur ESP32 pour la recherche en sécurité, la formation et le prototypage. Le dépôt héberge les projets actuels et accueillera de futurs labs sur les techniques offensives et défensives, les expérimentations sûres et les exercices red-team/blue-team.
...
- [![Issues](https://img.shields.io/github/issues/arn-c0de/AD8232-EMG?style=flat-square&color=blue)](https://github.com/arn-c0de/AD8232-EMG/issues) [**AD8232-EMG**](https://github.com/arn-c0de/AD8232-EMG) - Système EMG de surface sans fil ESP32 + AD8232 avec streaming Wi-Fi en temps réel, mises à jour OTA, calibration automatique et interface Python légère pour le suivi du signal en direct.
...
### Sécurité réseau
- [![Issues](https://img.shields.io/github/issues/arn-c0de/GDEF-L1NK?style=flat-square&color=blue)](https://github.com/arn-c0de/GDEF-L1NK/issues) [**GDEF-L1NK**](https://github.com/arn-c0de/GDEF-L1NK) - Plateforme modulaire de renseignement réseau pour la capture de paquets autorisée, l'agrégation d'appareils avec PostgreSQL, l'intégration de capteurs FritzDump, les statistiques en direct et la visualisation 3D interactive sur globe. **Licence:** MIT.
